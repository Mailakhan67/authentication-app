...
//               <label className="text-shadow-blue text-2xl text-[#000000]">
//                 First Name
//               </label>
//               <input
//                 type="text"
...
//                   type="email"
//                   placeholder="Enter your email"
//                   className="border border-gray-500 mx-2 rounded-md w-[480px] h-[39px]"
//                 />
//                 <FaUser className="absolute top-1/2 left-2 transform -translate-y-1/2 cursor-pointer w-[30px] h-[22px] text-white mt-[16px] ml-[510px]" />
//               </div>
//             </div>
//             <div className="my-2 p-3 relative">
//               <label className="text-shadow-blue text-2xl text-[#000000]">
...
//                   className="border border-gray-500 mx-2 rounded-md w-[480px] h-[39px]"
//                 />
//                 <FaLock className="absolute top-1/2 left-2 transform -translate-y-1/2 cursor-pointer w-[30px] h-[22px] text-white mt-[16px] ml-[510px]" />
//               </div>
//             </div>
//           </>
//         )}
      ...
      <form className="flex flex-col justify-center items-center">
        {isSignUp && (
          <>
            ...
            <div className="my-2 p-3">
              <label className="text-2xl text-[#000000]">Confirm Password</label>
              <input
                type="password"
                placeholder="Confirm your password"
                className="border border-gray-500 mx-2 rounded-md w-[550px] h-[39px]"
            ...
            <div className="my-2 p-3">
              <label className="text-2xl text-[#000000]">Phone Number (Optional)</label>
              <input
                type="text"
                placeholder="Enter your phone number"
                className="border border-gray-500 mx-2 rounded-md w-[550px] h-[39px] mt-2"
